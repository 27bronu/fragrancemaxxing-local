...
const Item = ({ id, name, size, brand, image, old_price, new_price}) => {
  ...
  return (
    <div className="rounded-xl overflow-hidden shadow-lg">
      ...
      <div className="p-4 overflow-hidden">
        <h4 className="my-[6px] medium-16 line-clamp-2 text-gray-30">{brand} | {name}</h4>
        <div className="text-secondary">{size}ml</div>
